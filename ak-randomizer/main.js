...
.controller('MyController', function($scope, $timeout, $interval, $location, $window) {
    ...
    function init() {
        ...
        .then(function() {
            return $.getJSON(`https://raw.githubusercontent.com/Kengxxiao/ArknightsGameData_YoStar/main/${vm.lang}/gamedata/excel/zone_table.json`, function(json) {
                zones = json;
            })
        })
        .then(function() {
            return $.getJSON(`https://raw.githubusercontent.com/Kengxxiao/ArknightsGameData_YoStar/main/${vm.lang}/gamedata/excel/stage_table.json`, function(json) {
                stages = json;
