...
.controller('MyController', function($scope, $timeout, $interval, $location, $window) {
    ...
    function init() {
        ...
        applyTheme()
        return $.getJSON(`https://raw.githubusercontent.com/${dataRepo}/master/${langFolder}/gamedata/levels/enemydata/enemy_database.json`, function(json) {
            enemy = json;
            log(enemy);
        })
        .then(function() {
    ...
    .then(function() {
        ...
        _.each(enemy.enemies, enemy => {
            ...
            enemy.url = 'https://raw.githubusercontent.com/ArknightsAssets/ArknightsAssets2/refs/heads/cn/assets/dyn/arts/enemies/' + enemy.Key + '.png'
